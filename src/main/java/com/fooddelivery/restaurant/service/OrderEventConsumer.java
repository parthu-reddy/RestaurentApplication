...
public class OrderEventConsumer {
    ...
    @java.lang.SuppressWarnings("all")
    public OrderEventConsumer(final ObjectMapper objectMapper, final RestaurantOrderRepository restaurantOrderRepository, final RestaurantActionService actionService, final org.springframework.transaction.support.TransactionTemplate transactionTemplate) {
