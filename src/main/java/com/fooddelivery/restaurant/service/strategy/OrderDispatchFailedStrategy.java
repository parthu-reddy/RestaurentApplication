...
public class OrderDispatchFailedStrategy implements RestaurantEventStrategy {
    ...
    public void process(JsonNode root) throws Exception {
        ...
        restaurantOrderRepository.findById(UUID.fromString(orderId)).ifPresent(order -> {
            order.setStatus("CANCELLED"); // Consider dispatch failure as cancelled for restaurant
    ...
    public String getEventType() {
        return EventType.DISPATCH_FAILED;
    }
}
